...
<head>
    ...
    <title>Pesquisa: <?php echo $search;?></title>
...
<body id="crs_bdy">
    ...
    <div class="cat_sec7">
        <br />
        <br />
        <p class="cat_sec_ttl"><?php echo "$cnt Resultados para \"$search\"";?></p>
        <div class="cat_sec7_desc"><i class="fas fa-exclamation-circle"></i> Não tem certeza? Tente pesquisar pelo instrutor</div>
        <div class="cat_sec7_opt">
            ...
            <ul class="cat_sec7_pop">
                ...
                <ul class="cat_sec7_ul">
                    ...
                    <li class="cat_sec7_li">Avaliação Mais Alta</li>
                    <li class="cat_sec7_li">Novos</li>
                </ul>
            </ul>
        ...
        <div class="cat_sec7_bdy">
            <div class="cat_sec7_sidebar" id="cat_sec7_sidebar">
                <div class="cdet">
                    <details class="ccdet">
                    <summary class="csum">Categoria</summary>
                ...
                <div class="cdet">
                    <details class="ccdet">
                    <summary class="csum">Languagens</summary>
                        <form action="" method="POST">
                            <ul class="cul">
                            <?php
