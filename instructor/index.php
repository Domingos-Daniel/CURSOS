        ...
        <div class="dash">
            ...
            <div class="dash_sec1">
                <div class="dash_sec1_box">
                    <div class="dash_sec1_box_ttl tx-ct"><i class="fas fa-video"></i>&nbsp; Cursos</div>
                    <div class="dash_sec1_box_bdy tx-ct"><div class="dash_sec1_no"><?php if(isset($crs_count)){ echo $crs_count;}else{ echo "No Data";} ?></div></div>
                    <a href="courses" class="dash_sec1_box_vw tx-ct">Ver</a>
                </div>

                <div class="dash_sec1_box">
                    <div class="dash_sec1_box_ttl tx-ct"><i class="fas fa-users"></i>&nbsp; Estudantes</div>
                    <div class="dash_sec1_box_bdy tx-ct"><div class="dash_sec1_no"><?php if(isset($stu_count)){ echo $stu_count;}else{ echo "No Data";} ?></div></div>
                    <a href="students" class="dash_sec1_box_vw tx-ct">Ver</a>
                </div>

                <div class="dash_sec1_box">
                    <div class="dash_sec1_box_ttl tx-ct">Cursos Vendidos</div>
                    ...
                    <a href="payments" class="dash_sec1_box_vw tx-ct">Ver</a>
                </div>
            </div>
            ...
            <div class="dash_sec2">
                <div class="student_details">
                    <div class="stu_d_h">Novas Adesões</div>
