        ...
        if(empty($err)==true && $let_dur != ""){
            if(move_uploaded_file($tmp_nm,$vd_dest)){
                if($db->insert('lectures',['crs_token'=>$crs_token,'sec_nm'=>$sec_nm,'lct_nm'=>$let_nm,'lct_dur'=>$let_dur,'lct_vid'=>$vd_nm])){
                    $msg="Aula adicionada com sucesso!";
                    ...
                    $err = "Não foi possível adicionar aula!";
                }
            }else{
    ...
    <div class="inst_ss">  
        ...
        <?php } ?>
            ...
            <div class="inst_crs_sec1">
                <div class="inst_crs_sec1_ttl">Add detalhes da Aula</div>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="inst_crs_det">
                            ...
                            <div class="inst_details_Sec">
                                <label for="inst_crs_sec_nm" class="inst_crs_det_lbl">Nome da Secção</label>
                            ...
                            <div class="inst_details_Sec">
                                <label for="inst_crs_let_nm" class="inst_crs_det_lbl">Nome da Lição</label>
                                <input type="text" class="inst_crs_inpt_det" name="inst_crs_let_nm" id="inst_crs_let_nm">
                            </div>

                            <div class="inst_details_Sec">
                                <label for="inst_crs_let_nm" class="inst_crs_det_lbl">Duração da Aula <small>Siga a ordem 00:00:00</small></label>
                        ...
                        <div class="inst_crs_det">
                            <div class="inst_selection">
                                <label for="inst_crs_vd" class="inst_crs_det_lbl">Ficheiro de Video</label>
                ...
                <div class="inst_crs_sec1">
                <div class="inst_crs_sec1_ttl">Actualizar detalhes da Lição</div>
                <div class="inst_crs_sec1_bdy">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="submit" name="get_details" value="Obter Dados da Lição" class="add_lect">
                        <br />
                        <br />
                    </form>
                    <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    if(isset($cntt)){
                                        if($cntt > 0){
                                            ...
                                            while($i<$cntt){
                                                ...
                                                <label for='inst_crs_let_nm' class='inst_crs_det_lbl2'>Nome da Lição</label>
                                                <input type='text' class='inst_crs_inpt_det' name='inst_crs_let_nm' id='inst_crs_let_nm' value='". $emm[$i]['lct_nm'] ."'>
                                                <label for='inst_crs_let_nm' class='inst_crs_det_lbl2'> Duração</label>
                                                ...
                                                <input type='submit' name='update' value='Actualizar' class='update_lect'>
                                                <form method='POST' action='' class='dform'>
                                                <input type='hidden' name='del_id' value='".$emm[$i]['id']."'>
                                                <input type='submit' name='delete' value='Apagar' class='delete_lect'>
                                                </form>
                                                </form>
                                                </div>  ";
                                                $i++;
