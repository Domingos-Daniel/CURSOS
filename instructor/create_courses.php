    ...
    <div class="inst_ss">  
        ...
        <div class="dash">
            ...
            <div class="inst_crs_sec1">
                <div class="inst_crs_sec1_ttl">Detalhes do Curso</div>
                <div class="inst_crs_sec1_bdy">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="inst_crs">
                            <label for="inst_crs_name" class="inst_crs_det_lbl">Nome do Curso</label>
                            <input class="inst_crs_inpt" type="text" name="inst_crs_name" id="inst_crs_name" value="<?php if(isset($crs_nme)){ echo $crs_nme; } ?>">
                        </div>
                        <div class="inst_crs">
                            <label for="inst_crs_tag"  class="inst_crs_det_lbl">Resumo do Curso</label>
                        ...
                        <div class="inst_crs_det">
                           <div class="inst_selection">
                                <label for="inst_crs_lang" class="inst_crs_det_lbl">Idioma</label>
                                <select class="inst_crs_lang" name="inst_crs_lang">
                                    ...
                                    <option <?php if(isset($crs_lngl) && $crs_lngl == "Portugues"){ echo "selected";} ?> value="Portugues">Portugues</option>
                        ...
                        <div class="inst_crs">
                            <label for="inst_crs_wul" class="inst_crs_det_lbl">O que o Estudante Aprenderá  <small>Separe as, usando "."(ponto)</small></label>
                        ...
                        <br>
                        <div class="inst_crs">
                            <label for="inst_crs_req" class="inst_crs_det_lbl">Requisitos <small>Separe as usando "."(ponto)</small></label>
                        ...
                        <br>
                        <div class="inst_crs">
                            <label for="inst_crs_desc" class="inst_crs_det_lbl">Descrição</label>
                        ...
                        <div class="inst_crs_det">
                            <div class="inst_details_Sec">
                                <label for="inst_crs_cat" class="inst_crs_det_lbl">Categoria</label>
                        ...
                        <div class="inst_crs_det">
                            <div class="inst_details_Sec">
                                <label for="inst_crs_art" class="inst_crs_det_lbl">Imagem do Curso</label>
                        ...
                        <div class="inst_crs_btn">
                            ...
                            <?php if(isset($_GET['crs_id'])){ ?>
                                <input type="submit" value="Actualizar" name="update" class="inst_crs_crt_btn inst_crs_btns" id="inst_crs_crt_btn">
                            <?php }else{ ?>
                            <input type="submit" value="Criar" name="submit" class="inst_crs_crt_btn inst_crs_btns" id="inst_crs_crt_btn">
                            <?php } ?>
                        </div>
