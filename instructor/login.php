...
<head>
    ...
    <title>Instructor Login | Ango-Cursos</title>
        ...
        <div class="login_modal" id="login_modal">
            ...
            <form action="" method="POST">
                ...
                <div class="sreme">
                    ...
                    <label for="srem" >Lembrar me</label>
                </div>
                <div class='lg_btn'>
                    <input type="submit" name="login" value="Login" id="llogin">
                    <a href="/ango-cursos" class="cancel_btn" id="cancel_btnlg">Cancel</a>
                </div>
            </form>
            <?php if(isset($err)){ ?>
            <div class="err">
            ...
            <?php } ?>
            <div class="lg_fr">ou <a href="../forgot_password?user=instructor">Esqueci a Password</a></div>
            <div class="lg_sg">Não Possui uma conta? Então <a href="signup" id="signup">Cadastre-se</a></div>
        </div>
    </div>
