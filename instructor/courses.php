...
$db->select('courses','crs_nm,crs_img,crs_token',null,"crs_creator='$usemail'", 'lst_upt DESC'); 
        ...
        <div class="dash">
            ...
            <div class="crs_h">Cursos</div>
                ...
                <div class="course_sec">
                    ...
                    <a href="add_lectures?crs_id=<?php if(isset($em[$i]['crs_token'])){echo $em[$i]['crs_token'];}?>" class="crs_add_lectures">Add/Editar Aulas</a>
                    <a href="create_courses?crs_id=<?php if(isset($em[$i]['crs_token'])){echo $em[$i]['crs_token'];}?>" class="crs_edit">Editar Curso</a>
                    <a href="delete_courses?crs_id=<?php if(isset($em[$i]['crs_token'])){echo $em[$i]['crs_token'];}?>" class="crs_delete">Deletar Curso</a>
                </div>
