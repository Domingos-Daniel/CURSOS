        ...
        <div class="login_modal">
            ...
            <form action="" method="POST">
                ...
                <div class='lg_btn'>
                    ...
                    <a type="button" onclick="goBack()" class="cancel_btn" id="cancel_btnlg">Cancel</a>
                </div>
            </form>
            <div class="lg_fr">ou <a href="forgot_password/?user=student">Esqueci a Password</a></div>
            <div class="lg_sg">Não possui conta? <a id="slogin_a" href="signup" class="a_btns">Registre-se</a></div>
        </div>
    </div>
