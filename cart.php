    ...
    <!-- Header Section End -->
        <?php
            if($cnt == 0){
                ...
                <div class='nc_t'>O seu carrinho está vazio. Continue navegando pelos itens!</div>
                <div class='nc_btn' onclick=\"location.href='./'\">Continue Comprando/div>
                </div>";
            }else {
        ?>
            ...
            <!-- <div class="login_ttl">Check Out</div> -->
                        ...
                        if($db->select('cart','cart_crs_token',null,"uemail = '$usemail'")){
                            ...
                            while($i < $cnt2){
                                ...
                                "<div class='ctt1'>
                                    ...
                                    <div id='ct3' class='ct3' crs='$crs_token2'>Remover</div>
                                    <div class='ct4'>
                                        <div class='ct4_1'>$crs_prcl AOA</div>
                                        <div class='ct4_2'>$crs_org_prcl AOA</div>
                                    </div>
                                </div>";
                                $i++;
                            }
                ...
                <div class="ct_p2">
                    ...
                    ?>
                    <div class="prc"><?php if(isset($total_disc)){global $total_disc;  echo $total_disc;}else{ if(isset($total)){ echo $total;}} ?> AOA</div>
                    ...
                    <form action="" method="POST" class="cpn_f">
                        <input type="text" name="coupon" id="coupon" class="coupon" placeholder="Insere o Coupon">
                        <input type="submit" class="apply_btn" id="apply_btn" name="apply" value="Verificar">
                    </form>
                    <?php
                    ...
                    if(isset($cpp)){
                        ...
                        $diff = $dt_df->format("%R%a");
                        if($diff > 0){
                             ?> <div class='cpn_appld'><span class='cpn_cl' id='clear'>X</span>&nbsp;&nbsp;<span class='cpn'><?php echo $cpp; ?><span class='cpn_t'> Foi aplicado</span></span></div> <?php
                        }else{
                            $err2 = "Coupon Expirado";
                        }
                        if(isset($err)){
                            echo "<div class='err2'>
                                <span>$err</span>
