...
<body id="crs_bdy">
    ...
    <div class="crs_sidebar">
       ...
       ?>
            <span class="crs_sbr_price crs_mr"><span class="crs_prce"> <?php if(isset($crs_prcl)){ echo $crs_prcl; } ?> <b>AOA</b></span> &nbsp;<span class="crs_discount"><?php if(isset($crs_org_prcl)){ echo $crs_org_prcl; } ?></span> &nbsp;<span class="crs_off"><?php if(isset($prct2)){ echo $prct2;} ?></span></span>
            <span class="crs_sbr_tme_lft crs_mr">
            <form action="" method="POST">
                <input type='submit' value='Adicionar ao Carrinho' name="add_to_cart" class='crs_sbr_btn add_btn crs_mr' id='add_to_cart' >
            </form>
            <?php
           ...
           ?>
            <a href="./checkout?crs_id=<?php if(isset($crs_token)){ echo $crs_token; } ?>" class="crs_sbr_btn buy_btn crs_mr" id="buy_nw">Comprar</a>

            <div class="crs_sbr_div crs_mr">
                <span class="crs_sbr_ttl crs_mr">Este curso Inclui:</span>
                <span class="crs_sbr_1 crs_mr"><i class="fas fa-file-video"></i>&nbsp; <span><?php if(isset($crs_durl)){ echo $crs_durl; } ?></span> Horas em Video</span>
                <span class="crs_sbr_2 crs_mr"><i class="fas fa-file-pdf"></i>&nbsp; <span><?php if(isset($crs_artl)){ echo $crs_artl; } ?></span> Artigos</span>
                <span class="crs_sbr_3 crs_mr"><i class="fas fa-download"></i>&nbsp; <span><?php if(isset($crs_dnrl)){ echo $crs_dnrl; } ?></span> Recursos para Download</span>
                <span class="crs_sbr_4 crs_mr"><i class="fas fa-infinity"></i>&nbsp; Acesso Mensal ao conteudo</span>
                <span class="crs_sbr_5 crs_mr"><i class="fas fa-mobile"></i>&nbsp; Acesso no Telemóvel e Computador</span>
                <span class="crs_sbr_6 crs_mr"><i class="fas fa-certificate"></i>&nbsp; Certificado de Conclusão</span>
            </div>

            <span class="crs_top_btn" onclick="w3.toggleShow('.crs_sidebar')" id="toggler">Fechar</span>
    ...
    <div class="c_top_header">
        <div class="c_top_sec1">
            ...
            <?php 
                ...
                ?>
            <span class="crs_line1 crs_cmm"><span class="bst_seller">Mais Vendido</span> <span class="sec_crs_ratings"><?php echo $rat_round; ?> (Avaliações)</span> <span class="auth_students"><?php if(!empty($cntc)){ echo $cntc . " " . "Estudantes";} ?></span></span>
            <span class="author crs_cmm">Criado Por <a href="#"><?php if(isset($iname)){ echo $iname; } ?></a></span>
            ...
            <span class="crs_btns crs_cmm">
                ...
                <span class="crs_top_btn" id="share_btn">Partilhar &nbsp;<i class="fas fa-share"></i></span>
                <span class="crs_top_btn" onclick="w3.toggleShow('.crs_sidebar')">OverView</span>
            </span>
            <span class="crs_top_btn" onclick="w3.toggleShow('.crs_sidebar')" id="toggler">OverView</span>
        </div>
    </div>
    <!-- Section 1 End  -->
    ...
    <div class="crs_sec2" id="crs_sec2">
        <ul class="crs_sec2_ul">
            <p class="crs_Sec2_ttl" id="crs_Sec2_ttl">O que vais Aprender</p>
    ...
    <div class="crs_sec3">
        <ul>
            <p class="crs_sec3_ttl">Requerimentos</p>
        ...
        <div>
            <p class="crs_sec3_ttl">Descrições</p>
    ...
    <div class="crs_sec5 crs_cmm_sec">
        <p class="crs_ec5_p1">Estudantes Também Compram</p> 
        <div class="crs_sec5_cor">
            <div class="crs_sec5_cor_img">
                <img src="images/courses/sample.png" alt="">
            </div>
            <div class="crs_sec5_div1">
                <p class="crs_sec5_ttl">Titulo do Curso</p>
                <div class="crs_sec5_idiv2">
                    <span class="crs_line1 crs_cmm"> <span class="crs_bst_seller">Mais Vendido</span> <span class="crs_hours">Horas</span> <span class="crs_updated">Actualizado</span></span>
                </div>
            </div>
            <div class="crs_sec5_div2">
                <p>Avaliações&nbsp; <i class="fas fa-star crs_sec7_icons"></i></p>
            </div>
            <div class="crs_sec5_div3">
                <p>Estudantes&nbsp;<i class="fas fa-user-friends"></i></p>
            </div>
            <div class="crs_sec5_div4">
                <p class="crs_sec5_4p1">Preço</p>
                <p class="crs_sec5_4p2">100 AOA</p>
            </div>
        ...
        <button class="shmore" id="crs_recent">Ver Mais</button>
    </div>
     ...
     <div class="crs_sec6 crs_cmm_sec">
        <p class="crs_sec6_ttl">Conteúdo do Curso</p>
        <?php
            ...
            if($cnttc != 0){
                ...
                $lects = $resc['0']['lct_nm'];
                $times = $resc['0']['time'];
                echo "<div class='crs_sec6_det'><span>$secs Secção (ões) • </span><span>$lects Aula (s) • </span><span> $times Duração Total</span></div>";
            }
        ?>
    ...
    <div class="crs_sec7 crs_cmm_sec">
        <p class="crs_Sec7_ttl">Instrutor</p>
        <p class="crs_Sec7_ins"><?php if(isset($iname)){ echo $iname; } ?></p>
        <p class="crs_Sec7_ins_det">Detalhes do Instrutor</p>
                ...
                <div class="crs_sec7_det">
                    <?php
                        ...
                        if(count($rev) > 0){
                            ...
                            echo "<p><i class='fas fa-medal crs_sec7_icons'></i>&nbsp; &nbsp;$rev_cnt Reconhecimentos</p>";
                        }else{
                            echo "<p><i class='fas fa-medal crs_sec7_icons'></i>&nbsp; &nbsp;0</p>";
                        }
                    ?>
                    <p><i class="fas fa-user-friends crs_sec7_icons"></i>&nbsp;&nbsp;<?php echo $cntc;?> Estudantes</p>
                    <p><i class="fas fa-play-circle crs_sec7_icons"></i>&nbsp; &nbsp;<?php if(isset($crs_count)){ echo $crs_count; } ?> Videos</p>
                </div>
            </div>
     ...
     <!-- Section 8 Start  -->
        <div class="crs_sec8 crs_cmm_sec">
            <p class="crs_sec8_p1">FeedBack dos Estudantes</p>
            <div class="crs_sec8_div">
                <div class="crs_sec8_div1">
                    <p class='crs_sec8_div1_p1'><?php echo $rat_round; ?></p>
                    <p class="crs_sec8_div1_p2">Estrelas</p>
                    <p class="crs_sec8_div1_p3">Avaliação do Curso</p>
                </div>
                <?php 
     ...
     <div class="crs_sec9 crs_cmm_sec">
            <form action="" id="comment_sec" class="comment_sec" method="POSt">
                ...
                <div class="comment_div">
                    <label for="ucomment" class="rating-h">Comentário</label>
                    <textarea name="ucomment" id="ucomment" rows="4"></textarea>
                </div>
                <input class="submit_btn_sec9" type="submit" value="Comentar" name="r_submit">
            </form>
        </div>
     <!-- Section 9 End  -->
     ...
     <div class="crs_review_sec crs_cmm_sec">
        <p class="crs_review_p1">Comentários</p>
...
<!-- 
            ...
            <button class="shmore" id="crs_review_shmr">Ver Mais</button>
     </div>
     <?php } ?>
     <!-- Section 10 End  -->
