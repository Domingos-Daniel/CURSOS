...
if(isset($_POST['update'])){
    ...
    if(($upassword == "") && ($upic == "")){
        if($db->update('user_data',"uname='$uname',uemail='$uemail'","uemail='$email'")){
            ...
            if($db->update('user_courses',"ucmail='$uemail'","ucmail='$email2'")){
            ...
            if($db->update('course_order',"stu_email='$uemail'","stu_email='$email2'")){
                $msg="EMAIL actualizados com sucesso!";
                $email = $uemail;
            }else{
                $err = "Unable to Update Data email!";
            ...
            $result_usuario = "UPDATE user_courses SET ucmail='$uemail' WHERE ucmail='$email2'";

            $resultado_usuario = mysqli_query($con, $result_usuario);
            $result_usuario = "UPDATE course_order SET stu_email='$uemail' WHERE stu_email='$email2'";
        ...
        <div class="stu_acc_set_r">
            ...
            <div class="stu_acc_set_bdy">
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="stu_acc_f">
                        <label for="stu_user_name" class="l_user_name l_stu_f">UserName:</label>
                    ...
                    <div class="stu_acc_f">
                        <label for="stu_pr_pc" class="l_pr_pc l_stu_f">Foto de Perfil:</label>
                        <input type="file" name="stu_pr_pc" id="stu_pr_pc" class="stu_pr_pc stu_f_inp">
                    </div>
                    <input type="submit" name="update" value="Actualizar" class="stu_acc_set_sbtn">
                </form>
                <br />
                <br />
                <?php if(isset($msg)){ ?>
