...
<div class="cnt_sec1">
    ...
    <div class="cnt_sec1_bnr_txt">
        <div>Melhorando vidas por mio do Ensino</div>
    </div>
</div>
<!-- Section 1 End -->
...
<div class="cnt_sec2">
    <div class="cnt_sec2_abt">
        <div class="cnt_sec2_abt1">O lider Nacional em plataformas de ensino a distância</div>
...
<div class="cnt_sec3">
    <form action="#" method="POST" id="cnt_form" class="cnt_form">
        <div class="cnt_name">
            <label for="cnt_name" class="cnt_lbl">Nome</label>
        ...
        <div class="cnt_msg">
            <label for="cnt_msg" class="cnt_lbl">Mensagem</label>
            <textarea name="cnt_msg" id="cnt_msg" class="int_cnt_msg"></textarea>
        </div>
        <div class="cnt_btn">
            <input type="submit" name="cnt_name" id="cnt_name" value="Enviar" class="cnt_snd_btn">
        </div>
    </form>
</div>
<!-- Section 3 End -->
